...
module FetchEmailAttachments
  module Hooks
    class ProjectEmailsHook < Redmine::Hook::ViewListener 
      render_on :view_project_emails_edit_notes_bottom, :partial => 'fetch_email_attachments/fetch_for_project_emails'
    end
  end
end
